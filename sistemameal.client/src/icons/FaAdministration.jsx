const FaAdministration = () => {
    return (
        <svg fill="currentColor" className="w-auto" height="1rem"viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <title>windows</title>
...
export default FaAdministration