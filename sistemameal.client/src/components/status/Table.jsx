...
const Table = ({ data, openModal, setEstados }) => {
    ...
    const headers = ['CODIGO', 'NOMBRE', 'COLOR', 'USUARIO_MODIFICADO','FECHA_MODIFICADO'];  // Tus encabezados
    const title = 'ESTADOS';  // El título de tu archivo
    const properties = ['estCod', 'estNom', 'estCol', 'usuMod', 'fecMod'];  // Las propiedades de los objetos de datos que quieres incluir
