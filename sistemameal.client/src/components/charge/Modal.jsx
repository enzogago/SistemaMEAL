...
const Modal = ({ closeModal, setData }) => {
    ...
    useEffect(() => {
        if (estadoEditado) {
            ...
            const nombre = estadoEditado.carNom.charAt(0).toUpperCase() + estadoEditado.carNom.slice(1).toLowerCase();
    ...
    return (
        <div className={`PowerMas_Modal ${modalVisible ? 'show' : ''}`}>
            <div className="PowerMas_ModalContent">
                ...
                <h2 className="center f1_5">{estadoEditado ? 'Editar' : 'Nuevo'} Cargo</h2>
