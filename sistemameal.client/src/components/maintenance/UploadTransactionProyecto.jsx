...
const UploadTransactionProyecto = ({ expectedHeaders, controller }) => {
            ...
            while (rowNumber <= worksheet.rowCount) { // Itera sobre todas las filas
                ...
                for (let colNumber = 2; colNumber <= 19; colNumber++) { // Itera desde la columna B (2) hasta la F (6)
                    ...
                    if (validationMessage !== true) {
                        newErrorCells.push({ row: rowNumber - 5, column: colNumber - 2,  message: validationMessage}); // Ajusta los índices para que coincidan con el rango de filas y columnas
                        setIsValid(false);
                    }
                }
...
export default UploadTransactionProyecto;
