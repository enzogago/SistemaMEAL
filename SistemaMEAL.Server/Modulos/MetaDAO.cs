...
namespace SistemaMEAL.Modulos
{
    public class MetaDAO
    {
        ...
        public (string? message, string? messageType) ModificarMetaEjecucion(ClaimsIdentity? identity, MetaEjecucion metaEjecucion)
        {
            var userClaims = new UserClaims().GetClaimsFromIdentity(identity);
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_MODIFICAR_META_EJECUCION", cn.getcn);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@P_METANO_ORIGINAL", metaEjecucion.MetAnoOri);
                cmd.Parameters.AddWithValue("@P_METCOD_ORIGINAL", metaEjecucion.MetCodOri);
                cmd.Parameters.AddWithValue("@P_UBIANO_ORIGINAL", metaEjecucion.UbiAnoOri);
                cmd.Parameters.AddWithValue("@P_UBICOD_ORIGINAL", metaEjecucion.UbiCodOri);
                cmd.Parameters.AddWithValue("@P_METEJEMESEJETEC_ORIGINAL", metaEjecucion.MetEjeMesEjeTecOri);
                cmd.Parameters.AddWithValue("@P_METEJEANOEJETEC_ORIGINAL", metaEjecucion.MetEjeAnoEjeTecOri);
        ...
        public (string? message, string? messageType) EliminarMetaEjecucion(ClaimsIdentity? identity, MetaEjecucion metaEjecucion)
        {
            var userClaims = new UserClaims().GetClaimsFromIdentity(identity);
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_ELIMINAR_META_EJECUCION", cn.getcn);
                cmd.CommandType = CommandType.StoredProcedure;
