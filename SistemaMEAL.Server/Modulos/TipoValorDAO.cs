...
namespace SistemaMEAL.Modulos
{
    public class TipoValorDAO
    {
        ...
        public IEnumerable<TipoValor> Listado()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SP_LISTAR_TIPOS_VALOR", cn.getcn);
                cmd.CommandType = CommandType.StoredProcedure;
                SqlDataReader rd = cmd.ExecuteReader();
                while (rd.Read())
                {
                    temporal.Add(new TipoValor()
                    {
                        TipValCod = rd.GetString(0),
                        TipValNom = rd.GetString(1),
