...
namespace SistemaMEAL.Modulos
{
    public class GeneroDAO
    {
       ...
       public IEnumerable<Genero> Listado(string? genCod = null, string? genNom = null)
        {
        ...
        public (string? message, string? messageType) Insertar(Genero genero)
        {
            string? mensaje = "";
            string? tipoMensaje = "";
            try
        ...
        public (string? message, string? messageType) Modificar(Genero genero)
        {
            string? mensaje = "";
            string? tipoMensaje = "";
            try
        ...
        public (string? message, string? messageType) Eliminar(string genCod)
        {
            string? mensaje = "";
            string? tipoMensaje = "";
            try
            {
                ...
                cmd.Parameters.AddWithValue("@P_GENCOD", genCod);
                cmd.Parameters.AddWithValue("@P_USUMOD", "Usuario");
                cmd.Parameters.AddWithValue("@P_LOGIPMAQ", "192.168.1.1");
                cmd.Parameters.AddWithValue("@P_USUANO_U", "2023");
                cmd.Parameters.AddWithValue("@P_USUCOD_U", "000001");
